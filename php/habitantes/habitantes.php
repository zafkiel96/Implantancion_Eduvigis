...
if ($action == 'list') {
    ...
    // Consultas para verificar duplicados específicos
    ...
    if ($check_cedula_result->num_rows > 0) {
        ...
        // Si no hay ninguna persona con esos datos, insertar la nueva persona en la base de datos
    ...
    // Consultas para verificar duplicados específicos excluyendo la persona actual
    ...
    if ($check_cedula_result->num_rows > 0) {
        ...
        // Si no se encuentra ninguna otra persona con los mismos datos, realizar la actualización en la base de datos
