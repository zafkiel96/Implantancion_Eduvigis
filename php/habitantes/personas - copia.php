            ...
            Swal.fire({
                ...
                html: `
                    <form id="editForm">
                        ...
                        <input type="text" id="edit_primer_nombre" value="${data.primer_nombre}"required pattern="[A-Za-zÁ-ÿ\s]*" maxlength="30" oninput="this.value = this.value.replace(/[^A-Za-zÁ-ÿ\s]/g, '');"><br>
                        <label for="edit_segundo_nombre">Segundo Nombre:</label>
                        <input type="text" id="edit_segundo_nombre" value="${data.segundo_nombre}" pattern="[A-Za-zÁ-ÿ\s]*" maxlength="30" oninput="this.value = this.value.replace(/[^A-Za-zÁ-ÿ\s]/g, '');"><br>
                        <label for="edit_primer_apellido">Primer Apellido:</label>
                        <input type="text" id="edit_primer_apellido" value="${data.primer_apellido}"required pattern="[A-Za-zÁ-ÿ\s]*" maxlength="30" oninput="this.value = this.value.replace(/[^A-Za-zÁ-ÿ\s]/g, '');"><br>
                        <label for="edit_segundo_apellido">Segundo Apellido:</label>
                        <input type="text" id="edit_segundo_apellido" value="${data.segundo_apellido}" pattern="[A-Za-zÁ-ÿ\s]*" maxlength="30" oninput="this.value = this.value.replace(/[^A-Za-zÁ-ÿ\s]/g, '');"><br>
                        ...
                        <input type="text" id="edit_telefono" value="${data.telefono}" pattern="\d*" maxlength="11";"><br>
                        <label for="edit_correo">Correo:</label>
                        <input type="email" id="edit_correo" value="${data.correo}" pattern="[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{3,}" oninput="this.setCustomValidity(''); if(!this.checkValidity()) this.setCustomValidity('Por favor, introduce un correo válido con al menos tres letras antes del punto y tres letras después del punto.');"><br>
                ...
                preConfirm: () => {
                    ...
                    if (!cedula) {
                        Swal.showValidationMessage('El campo Cédula es obligatorio.');
                        return false;
                    }
                    if (!primer_nombre) {
                        Swal.showValidationMessage('El campo Primer Nombre es obligatorio.');
                        return false;
                    }
                    if (!primer_apellido) {
                        Swal.showValidationMessage('El campo Primer Apellido es obligatorio.');
                        return false;
                    }
                    if (!fecha_nacimiento) {
                        Swal.showValidationMessage('El campo Fecha de Nacimiento es obligatorio.');
                        return false;
                    }
