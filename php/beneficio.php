                    ...
                    success: function(response) {
                        ...
                        if (response.trim() === 'success') {
                            ...
                            Swal.fire(
                                ...
                                response, // Mostrar el mensaje de error específico devuelto por el controlador
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td><button class="deleteButton" style="
                                    background-color: #d33;
                                    padding: 10px 10px 10px 10px;
                                    border-radius: 20px;
                                    " data-id="' . htmlspecialchars($row['id_beneficio']) . '">Eliminar</button></td>';
                                    echo '</tr>';
                                }
                            }
                            $conn->close();
