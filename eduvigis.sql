...
INSERT INTO `beneficios` (`id_beneficio`, `nombre_beneficio`, `fecha_entregado`, `status`) VALUES
(1, 'Cilindro Gas', '2024-05-09', 'Activo'),
(2, 'Bolsa Clap', '2024-05-01', 'Activo'),
(3, 'Nutricion', '2024-04-25', 'Activo'),
(4, 'Medicamentos', '2024-04-23', 'Activo'),
(5, 'Verdudera', '2024-05-12', 'Activo');
...
CREATE TABLE `casas` (
  ...
  `id_grupo_familiar` int(10) NOT NULL,
  `numero_casa` int(10) NOT NULL,
  `anexo_casa` varchar(60) NOT NULL,
  `ten_casa` enum('Propia','Alquilada') NOT NULL,
  `status` enum('Activo','Inactivo') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `casas` (`id_casa`, `id_manzana`, `id_grupo_familiar`, `numero_casa`, `anexo_casa`, `ten_casa`, `status`) VALUES
(1, 1, 1, 12, 'sin anexo', 'Propia', 'Activo'),
(2, 2, 2, 23, 'sin anexo', 'Propia', 'Activo'),
(3, 3, 3, 21, 'sin anexo', 'Alquilada', 'Activo'),
(4, 4, 4, 56, 'sin anexo', 'Alquilada', 'Activo');
...
INSERT INTO `comunidad` (`id_comunidad`, `id_manzana`, `nombre_comunidad`, `descripcion`, `observacion`) VALUES
(1, 1, 'Santa Eduviges', 'Comunidad \"Santa Eduviges\"\r\nUbicado en Barrio \"el Bolivar kilometro 8\"', 'Ninguna');
...
INSERT INTO `grupos_familiares` (`id_grupo_flia`, `nombre_familia`, `status`) VALUES
(1, 'Vasquez', 'Activo'),
(2, 'Flores', 'Activo'),
(3, 'Perdomo', 'Activo'),
(4, 'Valera', 'Activo');
...
--
-- Estructura de tabla para la tabla `historicos_beneficios`
--

CREATE TABLE `historicos_beneficios` (
  `id_hist_beneficio` int(10) NOT NULL,
...
--
-- Volcado de datos para la tabla `historicos_beneficios`
--

INSERT INTO `historicos_beneficios` (`id_hist_beneficio`, `id_usuario`, `id_tipo_usuario`, `id_grupo_flia`, `id_manzana`, `id_casa`, `id_beneficio`, `fecha`, `descripcion`, `observacion`, `status`) VALUES
(1, 1, 1, 1, 1, 1, 1, '2024-05-17', 'Entregado el gas', 'Ninguna', 'Entregado'),
(2, 4, 4, 4, 4, 4, 4, '2024-05-19', 'Entregado la bolsa', 'Ninguna', 'Entregado');
...
CREATE TABLE `personas` (
  ...
  `parentesco` enum('Padre','Madre','Hijo(a)','Hermano(a)','Suegro(a)','Yerno','Nuera') NOT NULL,
  `numero_hijos` int(10) NOT NULL,
...
INSERT INTO `tipos_usuarios` (`id_tipo_usuario`, `id_usuario`, `cedula`, `tipo`, `fecha_registro`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `usuarios_grupos_familiares`
--

CREATE TABLE `usuarios_grupos_familiares` (
  `id_usuario_g_f` int(10) NOT NULL,
  `id_usuario` int(10) NOT NULL,
  `id_grupo_flia` int(10) NOT NULL,
  `id_casa` int(10) NOT NULL,
  `parentesco` enum('Padre','Madre','Hijo(a)','Hermano(a)','Suegro(a)','Yerno','Nuera') NOT NULL,
  `jefe_familia` enum('SI','NO') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `usuarios_grupos_familiares`
--

INSERT INTO `usuarios_grupos_familiares` (`id_usuario_g_f`, `id_usuario`, `id_grupo_flia`, `id_casa`, `parentesco`, `jefe_familia`) VALUES
(1, 1, 1, 1, 'Padre', 'SI'),
(2, 2, 2, 2, 'Padre', 'SI'),
(3, 3, 3, 3, 'Padre', 'SI'),
(4, 4, 4, 4, 'Padre', 'SI');
...
ALTER TABLE `grupos_familiares`
  ADD PRIMARY KEY (`id_grupo_flia`);

--
-- Indices de la tabla `historicos_beneficios`
--
ALTER TABLE `historicos_beneficios`
  ADD PRIMARY KEY (`id_hist_beneficio`);
...
ALTER TABLE `manzanas`
  ...
  ADD UNIQUE KEY `id_manzana` (`id_manzana`,`numero_manzana`);
...
--
-- Indices de la tabla `usuarios_grupos_familiares`
--
ALTER TABLE `usuarios_grupos_familiares`
  ADD PRIMARY KEY (`id_usuario_g_f`);
...
--
ALTER TABLE `beneficios`
  MODIFY `id_beneficio` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `casas`
--
ALTER TABLE `casas`
  MODIFY `id_casa` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `comunidad`
  MODIFY `id_comunidad` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `grupos_familiares`
  MODIFY `id_grupo_flia` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `historicos_beneficios`
--
ALTER TABLE `historicos_beneficios`
  MODIFY `id_hist_beneficio` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `manzanas`
--
ALTER TABLE `manzanas`
  MODIFY `id_manzana` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `usuarios_grupos_familiares`
  MODIFY `id_usuario_g_f` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
